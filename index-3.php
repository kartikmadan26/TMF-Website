...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>LoveUs - Charity and Fundraising HTML Template | Home Page 03</title>
    <!-- Stylesheets -->
    ...
    <div class="page-wrapper">
      ...
      <section class="banner-section style-three">
        <div
          ...
          data-options='{"loop": true, "margin": 0, "autoHeight":false, "singleItem" : true, "autoplay": true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 300, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1024":{ "items" : "1" }}}'
        >
          <!-- Slide Item -->
          <div class="slide-item">
            <div
              class="image-layer lazy-image"
              data-bg="url('images/main-slider/7.jpg')"
            ></div>
            <div class="curved-layer"></div>

            <div class="auto-container">
              <div class="content-box">
                <h2>I Feel Like I'm Nothing Without Wildlife.</h2>
                <div class="text">
          ...
          <div class="slide-item">
            <div
              class="image-layer lazy-image"
              data-bg="url('images/main-slider/8.jpg')"
            ></div>
            <div class="curved-layer"></div>
          ...
          <div class="slide-item">
            <div
              class="image-layer lazy-image"
              data-bg="url('images/main-slider/9.jpg')"
            ></div>
            <div class="curved-layer"></div>
              ...
              <div class="inner-box wow fadeInUp" data-wow-delay="0ms">
                <div class="donate-info">
                  <div
                    ...
                    data-bg="url('images/resource/featured-image-13.jpg')"
                  ></div>
                ...
                <div class="lower-content">
                  <h3>
                    <a href="cause-single.html"
                      >Raise Fund <br />for Healthy Food</a
                    >
                  </h3>
                  <div class="text">
            ...
            <div class="cause-block alternate col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                <div class="donate-info">
                  <div
                    class="bg-image-layer lazy-image"
                    data-bg="url('images/resource/featured-image-14.jpg')"
                  ></div>
                  <div class="progress-box">
                    <div class="bar">
                      <div class="bar-inner count-bar" data-percent="70%">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="cause-single.html"
                      >Education <br />for Poor Children</a
                    >
                  </h3>
                  <div class="text">
                    Excepteur sint occaecat cupidatat non proident sunt.
            ...
            <div class="cause-block alternate col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box wow fadeInUp" data-wow-delay="600ms">
                <div class="donate-info">
                  <div
                    class="bg-image-layer lazy-image"
                    data-bg="url('images/resource/featured-image-15.jpg')"
                  ></div>
                  <div class="progress-box">
                    <div class="bar">
                      <div class="bar-inner count-bar" data-percent="70%">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="cause-single.html"
                      >Promoting The <br />Rights of Children</a
                    >
                  </h3>
                  <div class="text">
                    Excepteur sint occaecat cupidatat non proident sunt.
            ...
            <div class="cause-block alternate col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box wow fadeInUp" data-wow-delay="0ms">
                <div class="donate-info">
                  <div
                    class="bg-image-layer lazy-image"
                    data-bg="url('images/resource/featured-image-16.jpg')"
                  ></div>
                  <div class="progress-box">
                    <div class="bar">
                      <div class="bar-inner count-bar" data-percent="70%">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="cause-single.html"
                      >Promoting <br />The Rights of Birds</a
                    >
                  </h3>
                  <div class="text">
                    Excepteur sint occaecat cupidatat non proident sunt.
            ...
            <div class="cause-block alternate col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                <div class="donate-info">
                  <div
                    class="bg-image-layer lazy-image"
                    data-bg="url('images/resource/featured-image-17.jpg')"
                  ></div>
                  <div class="progress-box">
                    <div class="bar">
                      <div class="bar-inner count-bar" data-percent="70%">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="cause-single.html"
                      >Raise Fund <br />for Save Elephant</a
                    >
                  </h3>
                  <div class="text">
                    Excepteur sint occaecat cupidatat non proident sunt.
            ...
            <div class="cause-block alternate col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box wow fadeInUp" data-wow-delay="600ms">
                <div class="donate-info">
                  <div
                    class="bg-image-layer lazy-image"
                    data-bg="url('images/resource/featured-image-18.jpg')"
                  ></div>
                  <div class="progress-box">
                    <div class="bar">
                      <div class="bar-inner count-bar" data-percent="70%">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="cause-single.html"
                      >Safe Zone for <br />Royal Bengal Tiger</a
                    >
                  </h3>
                  <div class="text">
                    Excepteur sint occaecat cupidatat non proident sunt.
      ...
      <section class="team-carousel-section">
        <div class="auto-container">
          <div class="title-box clearfix">
            ...
            <div class="text">
              Lorem ipsum dolor amet consectetur adipisicing elit sed eiusmod
              tempor incidi.
            </div>
          </div>
          ...
          <!--Team Carousel-->
          <div
            class="team-carousel love-carousel owl-theme owl-carousel"
      ...
      <!--How It Work Section-->
      <section class="how-it-works no-padding-top">
        <div class="circle-one"></div>
            ...
            <div class="process-block col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box">
                <div class="image-box">
                  <figure class="image">
                    <img
                      class="lazy-image"
                      src="images/resource/image-spacer-for-validation.png"
                      data-src="images/resource/featured-image-6.jpg"
                      alt=""
                    />
                  </figure>
                </div>
                <div class="lower-content">
                  ...
                  <div class="text">
                    Lorem ipsum dolor amet consectetur adipisicing dolor magna
                    aliqua elit sed eiusmod tempor incididunt labore dolor magna
                    aliqua enim ad minimveniam quis nostrud exercita.
                  </div>
                  <div class="link-box">
                    <a href="donate.html" class="theme-btn btn-style-two"
                      ><span class="btn-title">Donate Now</span></a
                    >
                  </div>
                </div>
                ...
                <div class="image-box">
                  <figure class="image">
                    <img
                      class="lazy-image"
                      src="images/resource/image-spacer-for-validation.png"
                      data-src="images/resource/featured-image-7.jpg"
                      alt=""
                    />
                  </figure>
                </div>
            ...
            <div class="process-block col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box">
                <div class="image-box">
                  <figure class="image">
                    <img
                      class="lazy-image"
                      src="images/resource/image-spacer-for-validation.png"
                      data-src="images/resource/featured-image-8.jpg"
                      alt=""
                    />
                  </figure>
                </div>
                <div class="lower-content">
                  ...
                  <div class="link-box">
                    <a href="donate.html" class="theme-btn btn-style-two"
                      ><span class="btn-title">Give Us Now</span></a
                    >
                  </div>
                </div>
              </div>
      ...
      <section class="fluid-section">
        <div class="outer-container clearfix">
          ...
          <div class="image-column">
            <div
              class="image-layer lazy-image"
              data-bg="url('images/resource/video-image-2.jpg')"
            ></div>
            <div class="image-box">
              <figure class="image">
                <img
                  class="lazy-image"
                  src="images/resource/image-spacer-for-validation.png"
                  data-src="images/resource/video-image-2.jpg"
                  alt=""
                />
              </figure>
            </div>
          ...
          <div class="text-column">
            <div class="inner">
              ...
              <div
                ...
                "
                data-options='{"loop": true, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 5000, "smartSpeed": 700, "responsive":{ "0" :{ "items": "1" },"600" :{ "items": "1" }, "800" :{ "items" : "1" }, "1024":{ "items" : "1" }, "1366":{ "items" : "1" }}}'
              >
                <!--Slide Item-->
                <div class="slide-item">
                  <div class="text">
                    Lorem ipsum dolor sit amet consectetr adipicing elit usmod
                    tempor incidunt enim minim quis nostrud nis exer tation
                    ullamco laboris.
                  </div>
            ...
            <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
              <div class="inner-box wow fadeInLeft" data-wow-delay="0ms">
                ...
                <div class="lower-content">
                  ...
                  <h3>
                    <a href="blog-single.html">Raise Fund for Healthy Food</a>
                  </h3>
                  <div class="text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit sed
                  ...
                  <div class="link-box">
                    <a href="blog-single.html" class="theme-btn btn-style-one"
                      ><span class="btn-title">Read More</span></a
                    >
                  </div>
                </div>
                  ...
                  <div class="post-thumb">
                    <a href="blog-single.html"
                      ><img
                        class="lazy-image"
                        src="images/resource/image-spacer-for-validation.png"
                        data-src="images/resource/post-thumb-3.jpg"
                        alt=""
                    /></a>
                  </div>
                  <div class="date">
                    <span class="fa fa-calendar-alt"></span> Sep 25, 2019
                  </div>
                  <h4>
                    <a href="blog-single.html"
                      >The Study and The Town that Changed the Health of a
                      Generation</a
                    >
                  </h4>
                </div>
                  ...
                  <div class="post-thumb">
                    <a href="blog-single.html"
                      ><img
                        class="lazy-image"
                        src="images/resource/image-spacer-for-validation.png"
                        data-src="images/resource/post-thumb-4.jpg"
                        alt=""
                    /></a>
                  </div>
                  <div class="date">
                    <span class="fa fa-calendar-alt"></span> Sep 20, 2019
                  </div>
                  <h4>
                    <a href="blog-single.html"
                      >The Study and The Town that Changed the Health of a
                  ...
                  <div class="post-thumb">
                    <a href="blog-single.html"
                      ><img
                        class="lazy-image"
                        src="images/resource/image-spacer-for-validation.png"
                        data-src="images/resource/post-thumb-5.jpg"
                        alt=""
                    /></a>
                  </div>
                  <div class="date">
                    <span class="fa fa-calendar-alt"></span> Sep 14, 2019
                  </div>
                  <h4>
                    <a href="blog-single.html"
                      >The Study and The Town that Changed the Health of a
